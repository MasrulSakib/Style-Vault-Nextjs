        ...
        <div className={`flex justify-between items-center ${navbg ? 'bg-white shadow-lg shadow-blue-200' : 'fixed]'}
         transition-all duration-200 h-[12vh] px-4 lg:px-10 fixed top-0 w-full z-[100]`}>
            ...
            <div className='flex gap-5 justify-center items-center'>
                <button>
                    <Link href="#_" className="relative px-5 py-3 overflow-hidden font-medium text-black bg-blue-100 border border-blue-100 rounded-lg shadow-inner group">
                        ...
                        <span className="relative transition-colors duration-300 delay-200 group-hover:text-white ease">Create Account</span>
                    </Link>
                </button>
                {/* Hamburger Menu */}
